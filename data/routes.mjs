...
const notableAuxSeed = [
  aux("I-105", "I-5", { states: "CA", corridor: "Los Angeles region", summary: "Century Freeway connector serving LAX-area travel.", lengthMi: 19, year: 1993, cities: ["Los Angeles", "Norwalk"], notes: ["One of the last major urban freeways built in Los Angeles."] }),
  ...
  aux("I-805", "I-5", { states: "CA", corridor: "San Diego", summary: "Bypass route through the San Diego region.", lengthMi: 28, cities: ["San Diego"], notes: ["An inland bypass of I-5 through eastern San Diego."] }),
